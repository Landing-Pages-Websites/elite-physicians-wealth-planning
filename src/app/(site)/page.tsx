...
export const metadata: Metadata = {
  ...
  title: "Helping Physicians Keep More, Grow More, and Retire Better",
  alternates: { canonical: "/" },
};

/**
 * The approved homepage: Direction A, "The Consult Ledger", promoted to the
 * canonical root per the recorded homeSelectedVariant. Section order is the
 * approved page_flow and must not be reordered — the gold coordination route
 * crosses the seams in this sequence.
 */
